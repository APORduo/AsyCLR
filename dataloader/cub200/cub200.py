...
class CUB200(Dataset):
    ...
    def __init__(self, root='/home/dl/llzhao/CEC-CVPR2021/data/', train=True,
        ...
        self.train_transform = transforms.Compose([
                ...
                transforms.RandomResizedCrop(224,scale=(0.4,1)), #0.4 会更好
    ...
    def SelectfromClasses(self, data, targets, index):
        ...
        targets_tmp = []
        for i in index:
            ind_cl =[t for t in range(len(targets)) if targets[t] == i]
            #np.where(i == targets)[0]
            for j in ind_cl:
